...
export class EntradasListComponent implements OnInit {
  ...
  @Input() ultimaCargada: string;
  service: EntradasService
  entradas: Array<Entrada>=listaDeEntradas;
  displayedColumns: string[] = ['giro','buque', 'agencia', 'procedencia', 'destino','entrada','salida','muelle', 'trafico', 'documento', 'nroPasavante'];
  ...
  constructor(service: EntradasService,
              serviceBuque: BuquesService,
              serviceAgencia: AgenciasService,
